...
public class ArrayCircularQueue<E> implements QueueADT<E> {
	 ...
	 * frontmost element in this QueueADT.
	 */
	private int front;
	private int rear;
	...
	public E dequeue() throws EmptyCollectionException {
		 ...
		 * the queue, which corresponds to save element at the front index to a
		 * variable, named result, and move the front to its next index in circular
		 * array.
		 *
