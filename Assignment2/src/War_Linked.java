...
public class War_Linked {
	...
	public void give(StackADT<Card> stack1, StackADT<Card> stack2, QueueADT<Card> winner) {
		if (winner == hand1) {
		...
		try {
			while (!(stack1.isEmpty())) {
				// TODO pop off a card on top of stack1 and insert it to winner's pile in hand.
				// For example,
				// winner.
			...
			while (!(stack2.isEmpty())) {
				// TODO pop off a card on top of stack2 and insert it to winner's pile in hand.
				// For example,
				// wi
	...
	public void playRound() {
		try {
			...
			// TODO deal a card from the pile of each player to stack1 and stack2
	...
	/**
	 * Play a war over stack1 and stack2. If this ends the game because one player
	 * runs out of cards, give the cards to the winning player and return true.
